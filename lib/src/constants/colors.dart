...
const textFieldBorderColor = AppCustomColor(
  lightThemeColor: Color(0xFFEAEAEA),
  darkThemeColor: Color(0xFF393939),
);
...
const otpTimerTextColor = AppCustomColor(
  lightThemeColor: Color(0xFF675B5B),
  darkThemeColor: Color(0xFFFFFFFF),
);

const emptySpaceColor = AppCustomColor(
  lightThemeColor: Color(0xFFEEEEEE),
  darkThemeColor: Color(0xFF313131),
);

const otpVerificationHeadingColor = AppCustomColor(
  lightThemeColor: Color(0xFF474646),
  darkThemeColor: Color(0xFFFFFFFF),
);

const otpVerificationSubHeadingColor = AppCustomColor(
  lightThemeColor: Color.fromRGBO(0, 0, 0, 0.5),
  darkThemeColor: Color.fromRGBO(255, 255, 255, 0.5),
);

const productBackgroundColor = AppCustomColor(
  lightThemeColor: Color(0xFFF1EFEF),
  darkThemeColor: Color(0xFF262626),
);

const dividerColor = AppCustomColor(
  lightThemeColor: Color(0xFFEDEDED),
  darkThemeColor: Color(0xFF232323),
);

const itemContainerBGColor = AppCustomColor(
  lightThemeColor: Color(0xFFFFFFFF),
  darkThemeColor: Color(0xFF262626),
);

const removeIconBGColor = AppCustomColor(
  lightThemeColor: Color(0xFFFBFBFB),
  darkThemeColor: Color(0xFF393939),
);

const newsletterIssueOptionBoxColor = AppCustomColor(
  lightThemeColor: Color(0xFFFFFFFF),
  darkThemeColor: Color(0xFF585858),
);

const containerBorderColor = AppCustomColor(
  lightThemeColor: Color(0xFFEAEAEA),
  darkThemeColor: Color(0xFF232323),
);
